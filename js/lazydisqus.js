...
async function loadDisqus() {
    ...
    await addStyle('https://cdn.jsdelivr.net/npm/disqusjs@1.2.0/dist/disqusjs.css');
    // await addScript('https://chralpha.disqus.com/embed.js');
    await addScript('https://cdn.jsdelivr.net/npm/chrdnx@1.4.1/js/disqusJS.js');
}
